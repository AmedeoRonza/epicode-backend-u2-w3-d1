...
namespace Pizzeria.Controllers
{
    public class AmministrazioneController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdAdmin,Username,Password,Ruolo")] Amministrazione amministrazione)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdAdmin,Username,Password,Ruolo")] Amministrazione amministrazione)
        {
            if (ModelState.IsValid)
            {
